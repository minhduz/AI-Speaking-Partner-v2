...
**`FE/src/services/session.service.ts`** _(update)_
...
**`FE/src/hooks/use-chat.ts`** _(update)_
...
**`FE/src/app/(main)/chat/page.tsx`** _(update)_
...
const deckVisible =
  currentDeck !== null &&
  (currentDeck.status === "not_started" ||
